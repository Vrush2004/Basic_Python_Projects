...
lab_min_txt=Label(clock,text="Minutes",font=("Time New Roman",18,"bold"),bg="red",fg="white")
...
lab_mon_txt=Label(clock,text="Month",font=("Time New Roman",18,"bold"),bg="red",fg="white")
